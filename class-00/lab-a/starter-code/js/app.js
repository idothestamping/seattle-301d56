...
function displayPics(){
  ...
  // Answer: reference to variable 'rando' is not defined or recognized globally as 'const' specifically contains the variable within the displayPics() function only, preventing conole.log from recognizing it.
